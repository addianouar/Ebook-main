...
export const Hero2 = () => {
  ...
  const texts = {
    ...
    heroTitle: "ALCHEMY IN LAYERS Vol 1",
    heroDescription: `Alchemy in Layers is a journey into the heart of cake design: 10 exclusive recipes, designed in layers to guarantee flavor, elegance, and stability. Each base, insert, and cream has been carefully crafted to elevate your creations and give you perfect mastery between art and technique.`,
    heroHighlight: "Precise recipes tested by our students",
    heroBullets: [
      "Recipes designed for cake design",
  ...
  // ✨ Animated sparkles and orbs (same as Hero)
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16 xl:gap-24 w-full max-w-7xl 2xl:max-w-screen-2xl mx-auto">
        ...
        {/* IMAGE - Right Side - RESPONSIVE SIZING */}
        <div className="flex-1 w-full flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[280px] sm:max-w-[350px] md:max-w-[400px] lg:max-w-[450px] xl:max-w-[550px] 2xl:max-w-[650px]">
            ...
            <img
              src={alchemyBookCover}
              alt="Alchemy in Layers Book Cover"
              className="relative z-10 rounded-3xl shadow-2xl border-2 sm:border-4 border-[#C5912C]/30 object-cover w-full hover:scale-105 transition-all duration-500"
            />
          </div>
        </div>
      </div>
